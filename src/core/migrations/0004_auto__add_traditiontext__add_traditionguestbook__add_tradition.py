...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TraditionText'
        db.create_table('core_traditiontext', (
        ...
        db.send_create_signal('core', ['TraditionText'])

        # Adding model 'TraditionGuestbook'
        db.create_table('core_traditionguestbook', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tradition', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Tradition'])),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('dt_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ...
        db.send_create_signal('core', ['TraditionGuestbook'])

        # Adding model 'Tradition'
        db.create_table('core_tradition', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('content', self.gf('django.db.models.fields.TextField')(default='')),
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='master', to=orm['core.Role'])),
        ))
        db.send_create_signal('core', ['Tradition'])


    def backwards(self, orm):
        # Deleting model 'TraditionText'
        db.delete_table('core_traditiontext')

        # Deleting model 'TraditionGuestbook'
        db.delete_table('core_traditionguestbook')

        # Deleting model 'Tradition'
        db.delete_table('core_tradition')
