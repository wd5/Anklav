...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Role.tradition'
        db.alter_column('core_role', 'tradition', self.gf('django.db.models.fields.CharField')(default=None, max_length=20))
    ...
    models = {
        ...
        'core.role': {
            ...
            'tradition': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'null': 'True', 'blank': 'True'}),
