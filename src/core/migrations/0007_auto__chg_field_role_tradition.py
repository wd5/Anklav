...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Role.tradition' to match new field type.
        db.rename_column('core_role', 'tradition', 'tradition_id')
        # Changing field 'Role.tradition'
        db.alter_column('core_role', 'tradition_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Tradition'], null=True))
        # Adding index on 'Role', fields ['tradition']
        db.create_index('core_role', ['tradition_id'])


    def backwards(self, orm):
        # Removing index on 'Role', fields ['tradition']
        db.delete_index('core_role', ['tradition_id'])


        # Renaming column for 'Role.tradition' to match new field type.
        db.rename_column('core_role', 'tradition_id', 'tradition')
        # Changing field 'Role.tradition'
        db.alter_column('core_role', 'tradition', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    models = {
        ...
        'core.role': {
            ...
            'tradition': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['core.Tradition']", 'null': 'True', 'blank': 'True'}),
        ...
        'core.tradition': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'master': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'master'", 'to': "orm['core.Role']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
