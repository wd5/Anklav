...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tradition.type'
        db.add_column('core_tradition', 'type',
                      self.gf('django.db.models.fields.CharField')(default='tradition', max_length=15),
                      keep_default=False)


        # Changing field 'Tradition.master'
        db.alter_column('core_tradition', 'master_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Role']))

    def backwards(self, orm):

        # Deleting field 'Tradition.type'
        db.delete_column('core_tradition', 'type')


        # Changing field 'Tradition.master'
        db.alter_column('core_tradition', 'master_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.Role']))
