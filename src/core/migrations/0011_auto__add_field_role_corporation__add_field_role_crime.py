...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_role', 'corporation',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='corporation', null=True, blank=True, to=orm['core.Tradition']),
                      keep_default=False)

        # Adding field 'Role.crime'
        db.add_column('core_role', 'crime',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='crime', null=True, blank=True, to=orm['core.Tradition']),
                      keep_default=False)
