...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_duel', 'number_2', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Duel.number_1'
        db.alter_column('core_duel', 'number_1', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'DuelMove.move_1'
        db.alter_column('core_duelmove', 'move_1', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'DuelMove.result_2'
        db.alter_column('core_duelmove', 'result_2', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'DuelMove.result_1'
        db.alter_column('core_duelmove', 'result_1', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'DuelMove.move_2'
        db.alter_column('core_duelmove', 'move_2', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'DuelMove.result_2'
        db.alter_column('core_duelmove', 'result_2', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))

        # Changing field 'DuelMove.result_1'
        db.alter_column('core_duelmove', 'result_1', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))
