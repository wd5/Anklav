...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DDComment'
        db.create_table('core_ddcomment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Role'])),
            ('dt', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('content', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('core', ['DDComment'])

        # Adding model 'DDRequest'
        db.create_table('core_ddrequest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='request_author', to=orm['core.Role'])),
            ('dt', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('cost', self.gf('django.db.models.fields.TextField')()),
            ('assignee', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='assignee', null=True, blank=True, to=orm['core.Role'])),
            ('status', self.gf('django.db.models.fields.CharField')(default='created', max_length=20)),
        ))
        db.send_create_signal('core', ['DDRequest'])

        # Adding field 'Role.dd_number'
        db.add_column('core_role', 'dd_number',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'DDComment'
        db.delete_table('core_ddcomment')

        # Deleting model 'DDRequest'
        db.delete_table('core_ddrequest')

        # Deleting field 'Role.dd_number'
        db.delete_column('core_role', 'dd_number')
    ...
    models = {
        ...
        'core.ddcomment': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Role']"}),
        ...
        'core.ddrequest': {
            ...
            'assignee': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'assignee'", 'null': 'True', 'blank': 'True', 'to': "orm['core.Role']"}),
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'request_author'", 'to': "orm['core.Role']"}),
