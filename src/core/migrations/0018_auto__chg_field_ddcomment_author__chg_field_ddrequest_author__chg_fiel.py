...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DDComment.author'
        db.alter_column('core_ddcomment', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'DDRequest.author'
        db.alter_column('core_ddrequest', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'DDRequest.assignee'
        db.alter_column('core_ddrequest', 'assignee_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'DDComment.author'
        db.alter_column('core_ddcomment', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Role']))

        # Changing field 'DDRequest.author'
        db.alter_column('core_ddrequest', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Role']))

        # Changing field 'DDRequest.assignee'
        db.alter_column('core_ddrequest', 'assignee_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Role']))
