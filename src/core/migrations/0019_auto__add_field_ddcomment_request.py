...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DDComment.request'
        db.add_column('core_ddcomment', 'request',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.DDRequest']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DDComment.request'
        db.delete_column('core_ddcomment', 'request_id')
