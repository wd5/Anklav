...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TraditionFile'
        db.create_table('core_traditionfile', (
        ...
        db.send_create_signal('core', ['TraditionFile'])


    def backwards(self, orm):
        # Deleting model 'TraditionFile'
        db.delete_table('core_traditionfile')
