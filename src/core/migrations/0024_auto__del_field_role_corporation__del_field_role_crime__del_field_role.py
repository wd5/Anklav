...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Role.corporation'
        db.delete_column('core_role', 'corporation_id')

        # Deleting field 'Role.crime'
        db.delete_column('core_role', 'crime_id')

        # Deleting field 'Role.tradition'
        db.delete_column('core_role', 'tradition_id')


    def backwards(self, orm):
        # Adding field 'Role.corporation'
        db.add_column('core_role', 'corporation',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='corporation', null=True, to=orm['core.Tradition'], blank=True),
                      keep_default=False)

        # Adding field 'Role.crime'
        db.add_column('core_role', 'crime',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='crime', null=True, to=orm['core.Tradition'], blank=True),
                      keep_default=False)

        # Adding field 'Role.tradition'
        db.add_column('core_role', 'tradition',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='tradition', null=True, to=orm['core.Tradition'], blank=True),
                      keep_default=False)
