...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Tradition.master'
        db.delete_column('core_tradition', 'master_id')


    def backwards(self, orm):
        # Adding field 'Tradition.master'
        db.add_column('core_tradition', 'master',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='master', null=True, to=orm['core.Role'], blank=True),
                      keep_default=False)
