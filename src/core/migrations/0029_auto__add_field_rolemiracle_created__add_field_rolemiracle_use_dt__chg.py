...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RoleMiracle.created'
        db.add_column('core_rolemiracle', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=None, blank=True),
                      keep_default=False)

        # Adding field 'RoleMiracle.use_dt'
        db.add_column('core_rolemiracle', 'use_dt',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Miracle.name'
        db.alter_column('core_miracle', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):
        # Deleting field 'RoleMiracle.created'
        db.delete_column('core_rolemiracle', 'created')

        # Deleting field 'RoleMiracle.use_dt'
        db.delete_column('core_rolemiracle', 'use_dt')


        # Changing field 'Miracle.name'
        db.alter_column('core_miracle', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))
