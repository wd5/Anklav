...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Deal'
        db.create_table('core_deal', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('role', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Role'])),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Tradition'])),
        ...
        db.send_create_signal('core', ['Deal'])

        # Adding model 'RoleStock'
        db.create_table('core_rolestock', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('role', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Role'])),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Tradition'])),
            ('amount', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('core', ['RoleStock'])


    def backwards(self, orm):
        # Deleting model 'Deal'
        db.delete_table('core_deal')

        # Deleting model 'RoleStock'
        db.delete_table('core_rolestock')
