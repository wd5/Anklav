...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deal.dt_add'
        db.add_column('core_deal', 'dt_add',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=None, blank=True),
                      keep_default=False)

        # Adding field 'Deal.buyer'
        db.add_column('core_deal', 'buyer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='buyer', null=True, blank=True, to=orm['core.Role']),
                      keep_default=False)

        # Adding field 'Deal.dt_closed'
        db.add_column('core_deal', 'dt_closed',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deal.dt_add'
        db.delete_column('core_deal', 'dt_add')

        # Deleting field 'Deal.buyer'
        db.delete_column('core_deal', 'buyer_id')

        # Deleting field 'Deal.dt_closed'
        db.delete_column('core_deal', 'dt_closed')
