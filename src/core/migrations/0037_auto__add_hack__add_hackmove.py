...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Hack'
        db.create_table('core_hack', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hacker', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Role'])),
        ...
        db.send_create_signal('core', ['Hack'])

        # Adding model 'HackMove'
        db.create_table('core_hackmove', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hack', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Hack'])),
            ('dt', self.gf('django.db.models.fields.DateTimeField')(default=None)),
            ('move', self.gf('django.db.models.fields.CharField')(default=None, max_length=10, null=True, blank=True)),
            ('result', self.gf('django.db.models.fields.CharField')(default=None, max_length=10, null=True, blank=True)),
        ))
        db.send_create_signal('core', ['HackMove'])


    def backwards(self, orm):
        # Deleting model 'Hack'
        db.delete_table('core_hack')

        # Deleting model 'HackMove'
        db.delete_table('core_hackmove')
