...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TraditionHack'
        db.create_table('core_traditionhack', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hacker', self.gf('django.db.models.fields.related.ForeignKey')(related_name='hacker', to=orm['core.Role'])),
            ('security', self.gf('django.db.models.fields.related.ForeignKey')(related_name='security', to=orm['core.Role'])),
            ('state', self.gf('django.db.models.fields.CharField')(default='not_started', max_length=20)),
            ('hacker_number', self.gf('django.db.models.fields.CharField')(max_length=4)),
            ('security_number', self.gf('django.db.models.fields.CharField')(default=None, max_length=10, null=True, blank=True)),
            ('winner', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='winner', null=True, blank=True, to=orm['core.Role'])),
            ('result', self.gf('django.db.models.fields.CharField')(default=None, max_length=20, null=True, blank=True)),
            ('dt', self.gf('django.db.models.fields.DateTimeField')(default=None)),
        ))
        db.send_create_signal('core', ['TraditionHack'])

        # Adding model 'TraditionHackMove'
        db.create_table('core_traditionhackmove', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hack', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.TraditionHack'])),
            ('dt', self.gf('django.db.models.fields.DateTimeField')(default=None)),
            ('hacker_move', self.gf('django.db.models.fields.CharField')(default=None, max_length=10, null=True, blank=True)),
            ('hacker_result', self.gf('django.db.models.fields.CharField')(default=None, max_length=10, null=True, blank=True)),
            ('security_move', self.gf('django.db.models.fields.CharField')(default=None, max_length=10, null=True, blank=True)),
            ('security_result', self.gf('django.db.models.fields.CharField')(default=None, max_length=10, null=True, blank=True)),
        ))
        db.send_create_signal('core', ['TraditionHackMove'])


        # Changing field 'HackMove.dt'
        db.alter_column('core_hackmove', 'dt', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting model 'TraditionHack'
        db.delete_table('core_traditionhack')

        # Deleting model 'TraditionHackMove'
        db.delete_table('core_traditionhackmove')


        # Changing field 'HackMove.dt'
        db.alter_column('core_hackmove', 'dt', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'core.traditionhack': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'result': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'security': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'security'", 'to': "orm['core.Role']"}),
            'security_number': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'state': ('django.db.models.fields.CharField', [], {'default': "'not_started'", 'max_length': '20'}),
