...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TraditionHack.security_number'
        db.alter_column('core_traditionhack', 'security_number', self.gf('django.db.models.fields.CharField')(default='0', max_length=10))

        # Changing field 'TraditionHack.security'
        db.alter_column('core_traditionhack', 'security_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Role']))

    def backwards(self, orm):

        # Changing field 'TraditionHack.security_number'
        db.alter_column('core_traditionhack', 'security_number', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'TraditionHack.security'
        db.alter_column('core_traditionhack', 'security_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.Role']))
