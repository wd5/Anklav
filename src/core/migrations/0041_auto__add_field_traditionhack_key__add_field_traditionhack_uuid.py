...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TraditionHack.key'
        db.add_column('core_traditionhack', 'key',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=250),
                      keep_default=False)

        # Adding field 'TraditionHack.uuid'
        db.add_column('core_traditionhack', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TraditionHack.key'
        db.delete_column('core_traditionhack', 'key')

        # Deleting field 'TraditionHack.uuid'
        db.delete_column('core_traditionhack', 'uuid')
