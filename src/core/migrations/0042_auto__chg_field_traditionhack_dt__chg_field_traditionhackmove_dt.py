...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TraditionHack.dt'
        db.alter_column('core_traditionhack', 'dt', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'TraditionHackMove.dt'
        db.alter_column('core_traditionhackmove', 'dt', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'TraditionHack.dt'
        db.alter_column('core_traditionhack', 'dt', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'TraditionHackMove.dt'
        db.alter_column('core_traditionhackmove', 'dt', self.gf('django.db.models.fields.DateTimeField')())
