...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Role.defender'
        db.add_column('core_role', 'defender',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='role_security', null=True, blank=True, to=orm['core.Role']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Role.defender'
        db.delete_column('core_role', 'defender_id')
    ...
    models = {
        ...
        'core.role': {
            ...
            'defender': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'role_security'", 'null': 'True', 'blank': 'True', 'to': "orm['core.Role']"}),
